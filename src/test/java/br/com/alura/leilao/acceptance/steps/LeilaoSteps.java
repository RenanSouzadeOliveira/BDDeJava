...
public class LeilaoSteps {
	...
	public void prenche_o_formulario_com_dados_validos() {
		this.leiloesPage = novoLeilaoPage.preencheForm("Computador X1", "1500", "01/11/2020");
	}
	...
	public void o_novo_leilao_aparece_na_tabela() {
		Assert.assertTrue(this.leiloesPage.existe("Computador X1", "1500", "01/11/2020", "fulano"));
		this.browser.clean();
	}
}
